/**
 * Tool result formatting & i18n helpers (server-side)
 * Ported from electron/main/ai/tools/utils/format.ts — no Electron imports.
 */
...
export function t(key: keyof typeof i18nTexts, locale?: string): any {
...
/**
 * Format a message as compact text.
 * Output format: "2025/3/3 07:25:04 张三: 消息内容"
 */
...
/**
 * Format a time range for results.
 */
