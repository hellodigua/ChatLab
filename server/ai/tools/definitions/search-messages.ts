...
import { searchMessages } from '../../../services/queries/messages.js'
...
export function createTool(context: ToolContext): AgentTool<typeof schema> {
  return {
    ...
    execute: async (_toolCallId, params) => {
      ...
      const result = searchMessages(sessionId, params.keywords, effectiveTimeFilter, limit, 0, params.sender_id)
