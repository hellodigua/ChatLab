/**
 * Agent event handler (server-side)
 * Maps PiAgentCore events to AgentStreamChunk, tracks runtime state.
 * Ported from electron/main/ai/agent/event-handler.ts — no Electron imports.
 */
...
export class AgentEventHandler {
  ...
  /**
   * Create PiAgentCore event subscriber callback
   */
  createSubscriber(
