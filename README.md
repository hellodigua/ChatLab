...
| 微信       | 官方不支持导出，需第三方实现 | 是         |
| QQ         | 旧版支持导出（新版不支持）   | 是         |
| WhatsApp   | 官方支持导出 txt             | 是         |
| Discord    | 官方支持导出 json            | 是         |
| Messenger  | 官方支持导出 json/html       | 计划中     |
| Telegram   | 官方支持导出 json/html       | 计划中     |
| SnapChat   | 官方支持导出 html            | 计划中     |
| Viber      | 官方支持导出 csv             | 计划中     |
| LINE       | 官方支持导出 txt             | 计划中     |
| Kakao Talk | 官方支持导出 txt/csv         | 计划中     |
| BiP        | 官方支持导出 txt             | 计划中     |
